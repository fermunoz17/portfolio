    ...
    return (
        <div id="about" className="about-container">
            <div className="left-column">
                ...
                <p>
                    My professional and academic experience spans roles as a computer science peer leader at EPCC, a full-stack software engineering intern at Steele Consulting Inc., a software engineer intern at American Express, and a Statistical Research Associate at El Paso Community College. In my software engineering internships, I contributed to full-stack and internal tooling projects in Agile environments, including enhancing an internal testing tool at American Express with ReactJS, Spring Boot, and Docker to improve accessibility and team productivity. As a statistical research associate, I expanded my analytical and research skills through technical investigation and scholarly work, including co-authoring research on fairness in intelligent systems and self-driving cars.                </p>
                <p>
